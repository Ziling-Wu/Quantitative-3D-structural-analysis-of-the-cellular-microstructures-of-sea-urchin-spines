...
%  Author: Ziling Wu (zilingwu@vt.edu)
%  Date:   9 Jan 2020
%  In this main code, the whole data processing of cellular structure is
%  included. 
% ==========================================
...
for slice = startPage:endPage
    im = double(imread([imageName,num2str(slice,['%0',num2str(sigDigits),'d']),...
        style]));
...
save([folder,'node_final.mat'],'node_final') % save registered nodes
save([folder,'bran_final.mat'],'bran_final') % save registered branches
save([folder,'connect_final.mat'],'connect_final') % save registered connections
